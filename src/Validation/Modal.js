...
class Modal extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        // Kiểm tra nếu state trước đó khác với state hiện tại
        // Và thực hiện các hoạt động dựa trên sự thay đổi của state
        for (let key in prevState.values) {
            if (prevState.values.hasOwnProperty(key) &&
                (prevState.values[key] === '' || prevState.values[key] === null)
                && prevProps.sendedituser !== null
            ) {
                prevState.values[key] = prevProps.sendedituser[key];
            }
        }
        console.log(prevState.values);
        this.props.editFormData(prevState.values);
    }
                        ...
                        <div className="modal-content">
                            <form onSubmit={this.handleSubmit} className="form-card">
                                <div className="modal-header">
                                    <h1 className="modal-title fs-5" id="editFormLabel">Edit User</h1>
                                ...
                                <div className="modal-body row">
                                    ...
                                    <div className="form-group col-sm-6">
                                        ...
                                        <input
                                            ...
                                            name="email"
                                            defaultValue={this.props.sendedituser?.email}
                                    ...
                                    <div className="form-group col-sm-6 ">
                                        ...
                                        <input
                                            ...
                                            name="masv"
                                            defaultValue={this.props.sendedituser?.masv}
                                            onChange={this.handleOnchange}
                                            onBlur={this.handleOnchange}
                                        />
                                        {errors.masv && (
                                    ...
                                    <div className="form-group col-sm-6 ">
                                        ...
                                        <input
                                            ...
                                            name="fullname"
                                            defaultValue={this.props.sendedituser?.fullname}
                                    ...
                                    <div className="form-group col-sm-6 ">
                                        ...
                                        <input
                                            ...
                                            defaultValue={this.props.sendedituser?.phone}
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="button" className="btn btn-primary d-none" onClick={this.handleSubmit}>Save changes</button>
                                </div>
                            </form>
                        </div>
                    </div>
